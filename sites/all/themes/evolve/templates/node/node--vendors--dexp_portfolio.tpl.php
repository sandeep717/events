...
// We hide the comments and links now so that we can render them later.
    ...
    $portfolio_images = field_get_items('node', $node, 'field_gallery');

    // echo '<pre>'; print_r($portfolio_images); 
    // For empty gallery
    // if(count($portfolio_images) == 1){
    //   $portfolio_images = array(0 => array('uri' => 'public://IMG_20160211_170739.jpg') );
    // }
    //echo '<pre>'; print_r($portfolio_images); 
    
    $first_image = '';
    if(count($portfolio_images) == 1){
        $first_image = 'http://localhost/events-vendors/sites/default/files/styles/portfolio/public/img-01_0.jpg?itok=jE47sYSw';
    }else{
